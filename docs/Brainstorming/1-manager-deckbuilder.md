...
Based on the auto battler genre analysis in [Game Genres](../Research/1-game-genres) and the structural properties of the preparation-then-execution loop:
...
This section captures the findings from the genre analysis in [Game Genres](../Research/1-game-genres) applied specifically to this concept. It covers what to get right, and the most common pitfalls that cause games in this hybrid space to fail.
