...
- [meta/1-design-notes.md](../6-meta/1-design-notes.md) — resolved design tensions

> The narration system is defined in `../brainstorming/3-storyline.md` and is not repeated here. See backlog item M7.
