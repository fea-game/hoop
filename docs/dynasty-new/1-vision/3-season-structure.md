...
**What persists:**
- The coaching identity and reputation (affects free agent attraction, job offers)
- Identity Cards (the coaching legacy toolkit — see [structure/1-card-systems.md](../2-structure/1-card-systems.md))
- The historical record (league lore, rivalries, narrative archive — see `../brainstorming/3-storyline.md`)
- Cross-run unlocked Identity Cards (available to future coaching runs as starting options)

> **Conflict:** "trade leverage" was listed here as a reputation benefit, but trades do not exist in this game. See backlog item M4.
...
> **Conflict:** Whether the prior team counts as one of the 2–3 offer slots or a separate additional option is unresolved. See backlog item H1.

> **Open:** The reputation scoring model (range, formula, tier thresholds) is not yet defined. See backlog items H7 and Q9.
