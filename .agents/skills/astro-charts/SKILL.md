...
Read `docs/src/charts/AGENTS.md` immediately — it contains all hard constraints,
...
Whenever a new pattern, convention, or strategy emerges during chart work — or an existing one changes or is found to be incorrect — update `docs/src/charts/AGENTS.md` and `docs/src/charts/README.md` before finishing the task. Do not leave discoveries undocumented.
